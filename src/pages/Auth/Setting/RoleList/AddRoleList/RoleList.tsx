...
export const  RoleList= () => {
    ...
    const[addRoledesc, setAddRoledesc] =  React.useState();
    ...
    const handleAddRole = async () => {
        const deviceRef = collection(db, 'rolelist');
  ...
  return (
    <div className='role__list-page'>
            ...
            <div className="role__list-infor-row">
                <div className="role__list-infor-column">
                    <div className="role__list-infor-column-infor">
                        ...
                        <input type="text" placeholder="Nhập tên vai trò" onChange={(e: any) => setAddRolename(e.target.value)}/>
                        <div className="role__list-infor-column-title">
                         Mô tả:
                        </div>
                        <textarea rows={10} cols={50} name="message" placeholder="Nhập mô tả" onChange={(e: any) => setAddRoledesc(e.target.value)}></textarea>
        ...
        <div className="role__list-btn">
                ...
                <input type="submit" className='role__list-btn--submit btn primary-btn' value='Thêm' onClick={handleAddRole}/>
          </div>
    </div>
  )
}

            ...
            <div className="device__managerment-infor-column-other ">
              ...
              <div className="device__managermaent-infor-column-input">
                ...
                <div className="device__managermaent-infor-column-list device__managermaent-infor-column-list-other">
                      <ul>
                          <li className="device__managermaent-infor-column-list-item">Tất cả</li>
                          <li className="device__managermaent-infor-column-list-item">Khám răng hàm mặt</li>
                          <li className="device__managermaent-infor-column-list-item">Khám tai mũi họng</li>
                          <li className="device__managermaent-infor-column-list-item">Khám tim mạch</li>
                          <li className="device__managermaent-infor-column-list-item">Khám sản phụ khoa</li>
                          <li className="device__managermaent-infor-column-list-item">Khám tim mạch</li>
                          <li className="device__managermaent-infor-column-list-item">Khám hô hấp</li>
                          <li className="device__managermaent-infor-column-list-item">Khám tổng quát</li>
                      </ul>
                </div>
              </div>
